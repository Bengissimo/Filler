...
echo "" > trace_map_02.txt

echo "---map02--- player1: bkandemi"

echo "CHAMPELY"

echo "bkandemi(O) against champely(X) map02" >> trace_map_02.txt
for i in {1..5}; do
   ./filler_vm -p1 ../bkandemi.filler -v -f maps/map02 -p2 players/champely.filler > game_trace_map_02.txt
   grep "fin" game_trace_map_02.txt | tail -2 >>trace_map_02.txt
   echo "" >> trace_map_02.txt
done

echo "ABANLIN"

echo "bkandemi(O) against abanlin(X) map02" >>trace_map_02.txt
for i in {1..5}; do
...
echo "bkandemi(O) against hcao(X) map02" >>trace_map_02.txt
for i in {1..5}; do
...
echo "bkandemi(O) against grati(X) map02" >>trace_map_02.txt
for i in {1..5}; do
...
echo "bkandemi(O) against carli(X) map02" >>trace_map_02.txt
for i in {1..5}; do
...
echo "bkandemi(O) against superjeannot(X) map02" >>trace_map_02.txt
for i in {1..5}; do
...
#echo "CHAMPELY"
#
#echo "champely(O) against bkandemi(X) map02" >> trace_map_02.txt
#for i in {1..5}; do
...
#echo "ABANLIN"
#
#echo "abanlin(O) against bkandemi(X) map02" >>trace_map_02.txt
#for i in {1..5}; do
...
#echo "HCAO"
#
#echo "hcao(O) against bkandemi(X) map02" >>trace_map_02.txt
#for i in {1..5}; do
...
#echo "GRATI"
#
#echo "grati(O) against bkandemi(X) map02" >>trace_map_02.txt
#for i in {1..5}; do
...
#echo "CARLI"
#
#echo "carli(O) against bkandemi(X) map02" >>trace_map_02.txt
#for i in {1..5}; do
...
#echo "SUPERJEANNOT"
#
#echo "superjeannot(O) against bkandemi(X) map02" >>trace_map_02.txt
#for i in {1..5}; do
